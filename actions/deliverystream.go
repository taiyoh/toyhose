...
func (d *DeliveryStream) Describe(input *port.Input, output *port.Output) error {
	return nil
}

func (d *DeliveryStream) List(input *port.Input, output *port.Output) error {
	return nil
}

func (d *DeliveryStream) PutRecord(input *port.Input, output *port.Output) error {
	return nil
}

func (d *DeliveryStream) PutRecordBatch(input *port.Input, output *port.Output) error {
	return nil
}
